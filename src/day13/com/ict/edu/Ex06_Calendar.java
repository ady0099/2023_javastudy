...
public class Ex06_Calendar {
	public static void main(String[] args) {
		// Canlendar 클래스 : new 예약어를 사용하지 않고 getInstance()를 사용하면 현재 PC 날짜와 시간으로 설정됨
		...
		System.out.print(now.get(Calendar.HOUR) + "시 "); // 12시간 (오전/오후 필요)
		...
		// 요일 (1(일요일)....7(토요일))
		res = now.get(Calendar.DAY_OF_WEEK) - 1;
		switch (res) {
		case 0:
