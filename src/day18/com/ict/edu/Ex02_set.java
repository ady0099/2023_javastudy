...
public class Ex02_set {
	public static void main(String[] args) {
		...
		// 형식 : HaswSetg( 제너릴타입= 객체타입=클래스> 참조변수 = new HashSet<[제네릭타입=객체타입=클래스^]>();
		// 형식 : HaswSetg( 제너릴타입= 객체타입=클래스> 참조변수 = new HashSet<[제네릭타입=객체타입=클래스^]>();
		...
		h1.add(20);	// 오토박싱 : 기본 자료형이 해당 객체로 만들어진다.
					// 오토언박싱 :해당 객체를 기본자료형으로 되돌린 것
		
		System.out.println(h1);
		
		h2.add(new Double(30.1));
		h2.add(new Double("35.11"));
		h2.add(38.2);
		// h2.add(30); // 무조건 제네릭타입을 맞춰야한다.
