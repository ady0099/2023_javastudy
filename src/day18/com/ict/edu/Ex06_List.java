...
public class Ex06_List {
	...
	public static void main(String[] args) {
		...
		if(stack.contains("둘리")) {
			...
			System.out.println(stack.get(stack.indexOf("둘리"))); // 둘리가 있을 때 둘리의 위치값으로 둘리를 찾음
		}else {
