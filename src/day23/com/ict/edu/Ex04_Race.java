...
public class Ex04_Race extends JFrame {
	...
	private class CanvasTest extends Canvas {
		...
		public void paint(Graphics g) {
			image1 = Toolkit.getDefaultToolkit().getImage("src/img/java1.png");
			image2 = Toolkit.getDefaultToolkit().getImage("src/img/java2.png");
			image3 = Toolkit.getDefaultToolkit().getImage("src/img/java3.png");
			image4 = Toolkit.getDefaultToolkit().getImage("src/img/java4.gif");
