...
// 주요 생성자 : File(String 경로), File(String 상위 경로, String 하위 경로)
...
//				파일과 디렉토리 차이점 	: 크기가 존재가 하면 파일
//				list() 				: 특정위치의 내용(파일, 디렉토리)을 배열에 저장
//				exists()			: 존재유무
//				getName()			: 이름반환
//				length()			: 파일 크기를 byte로 변환해서 표시
//				getAbosolutePath()	: 절대 주소표시(root부터 시작해서 위치표시)
//				getPath()			: 상대 주소표시(현재위치부터 시작해서 위치표시)
public class Ex01_File {
	public static void main(String[] args) {
		// java 에서 경로 구분자 표시 알아서 자동으로 인식하는 방법
		// 윈도우 에) C:\temp\...
		// 리눅스 예) /home/yangyag/..
		String pathname = "D:/ady";
